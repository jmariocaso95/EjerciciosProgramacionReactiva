...
public final class DomainExceptions {
    ...
    public static class ServicioExternoException extends DomainException {
        public ServicioExternoException(String msg) { super(HttpStatus.SERVICE_UNAVAILABLE, msg); }
    }
}
